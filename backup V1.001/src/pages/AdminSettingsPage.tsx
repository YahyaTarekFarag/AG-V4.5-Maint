                ...
                <div className="bg-white rounded-3xl border border-surface-200 shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="pt-4 border-t border-surface-100">
                            <div className="flex items-center justify-between p-4 bg-surface-50 rounded-2xl border border-surface-100">
                                <div className="flex-1">
                                    <h3 className="font-bold text-surface-900">تفعيل الرادار الجغرافي (Geofencing)</h3>
                                    <p className="text-sm text-surface-500 mt-1">
                                        إلزام الفنيين بالتواجد داخل نطاق الفرع لبدء العمل، وإلزام المديرين بالتواجد لفتح بلاغ.
                                    </p>
                                </div>
                                <button
                        ...
                        <div className="flex items-center justify-between p-4 bg-surface-50 rounded-2xl border border-surface-100">
                            <div className="flex-1">
                                <h3 className="font-bold text-surface-900">نطاق السماح الجغرافي (متر)</h3>
                                <p className="text-sm text-surface-500 mt-1">
                                    المسافة القصوى المسموح بها (بالمتـر) بين موقع المستخدم وموقع الفرع.
                                </p>
                            </div>
                            <div className="w-32">
                                <input
                                    ...
                                    className="w-full px-4 py-2 rounded-xl border border-surface-200 focus:ring-2 focus:ring-primary-500 outline-none font-bold text-center text-lg"
                                    placeholder="100"
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end p-2 gap-4 items-center">
                            ...
                            >
                                ...
                                {saving ? 'جاري الحفظ...' : 'حفظ الإعدادات الجديدة'}
                            </button>
                        </div>
                    </div>
                </div>
