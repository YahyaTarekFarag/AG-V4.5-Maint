...
import { KPICardConfig } from '@/engine/components/SovereignKPICard';
import SovereignKPICard from '@/engine/components/SovereignKPICard';
import {
...
import { suggestLabel } from '@shared/lib/sovereign-dictionary';
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            ...
                                            {[
                                                ...
                                                { id: 'maintenance_manager', label: 'مدير الصيانة الاستراتيجي' },
